...
public class udpBall : MonoBehaviour
{
    ...
    private void Start() 
    {
        manager = FindObjectOfType<BallTracking>(); // Instead of using a public variable
    }
    ...
    private void ProcessInput(string input)
    {
        ...
        manager.UpdatePythonRcvdText(input); // Update text by string received from python
